            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-8">
                            <div class="form-group"><label for="postal-code" class=" form-control-label">Profession</label><input type="text" id="postal-code" placeholder="enter profession" class="form-control"></div>
                        </div>
                    </div>
